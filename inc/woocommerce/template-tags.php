...
if ( ! function_exists( 'shop_isle_cart_link' ) ) {
	function shop_isle_cart_link() {
		?>
			<a class="cart-contents" href="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" title="<?php esc_attr_e( 'View your shopping cart', 'shop-isle' ); ?>">
...
if ( ! function_exists( 'shop_isle_upsell_display' ) ) {
	function shop_isle_upsell_display() {
		...
		$related = $product->wc_get_related_products();
